...
export const liveTourPackages = [
  {
    ...
    inclusions: ['বাস', 'নাস্তা', 'রাতের খাবার', 'কটেজ'],
  ...
  },
  {
    ...
    duration: '২ রাত ৩ দিন', totalSeats: 40, bookedSeats: 26,
    pricePerPerson: 6500, isJointTour: true, tourType: 'combine',
    coOrganizers: [tourGroups[0]],
    partnerGroups: [
      {
        groupId: 'tg5',
  ...
  },
  {
    ...
    operator: tourGroups[0], destination: destinations[3],
    route: 'ঢাকা → চট্টগ্রাম → বান্দরবান → বগালেক → ঢাকা',
    startDate: '৫ নভেম্বর ২০২৬', endDate: '৮ নভেম্বর ২০২৬',
    duration: '৩ রাত ৪ দিন', totalSeats: 40, bookedSeats: 19,
    pricePerPerson: 5500, isJointTour: false, tourType: 'own',
    coOrganizers: [],
    partnerGroups: [],
    seatTransfers: [],
    inclusions: ['বাস', 'গাইড', 'সব খাবার', 'হোটেল'],
